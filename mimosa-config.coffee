...
exports.config = {
  ...
  ###
  modules: ['lint', 'server', 'require', 'minify', 'live-reload', 'mimosa-requirebuild-textplugin-include', 'mimosa-client-jade-static', 'web-package']
  ...
  ###
  copy:
    extensions: ["js","css","png","jpg","jpeg","gif","html","eot","svg","ttf","woff","otf","yaml","kml","ico","htc","htm","json","txt","xml","xsd","csv"]	
  ...
  lint:                        # settings for js, css linting/hinting
    ...
    compiled:                  # settings for compiled files
      javascript: false        # fire jshint on successful compile of meta-language to javascript
    ...
    copied:                    # settings for copied files, files already in .css and .js files
      javascript: false        # fire jshint for copied javascript files
